         ...
         <div class="col-md-5">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-4">
                        <asp:Button ID="Button1" class="btn btn-lg btn-block btn-success col-12" runat="server" Text="Add" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Button3" class="btn btn-lg btn-block btn-warning col-12" runat="server" Text="Update" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Button2" class="btn btn-lg btn-block btn-danger col-12" runat="server" Text="Delete" />
                     </div>
                  </div>
               </div>
            </div>
